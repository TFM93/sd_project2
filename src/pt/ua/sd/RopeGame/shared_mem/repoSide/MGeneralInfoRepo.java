 ...
 */
 class MGeneralInfoRepo implements IRepoCoach, IRepoContestant, IRepoReferee{
     ...
     */
    MGeneralInfoRepo(int players_team, int players_pushing, int n_trials, int n_games, int knockDif)
    {
