...
public class ServerComChannel {
    ...
    /**
     * Stream de entrada do canal de comunicacaoo
     *
     * @serialField in
     */
    ...
    /**
     * Stream de saida do canal de comunicacaoo
     *
     * @serialField out
     */
    ...
    /**
     * Estabelecimento do servico. Instanciacao de um socket de escuta e sua
     * associacao ao endereco da maquina local e ao port de escuta publicos.
     */
    public void start() {
        try {
    ...
    /**
     * Encerramento do servico. Fecho do socket de escuta.
     */
    public void end() {
        try {
    ...
    /**
     * Processo de escuta. Criacao de um canal de comunicacao para um pedido
     * pendente. Instanciacao de um socket de comunicacao e sua associacao ao
     * endereco do cliente. Abertura dos streams de entrada e de saida do
     * socket.
     *
     * @return canal de comunicacao
     */
    public ServerComChannel accept() {
        ServerComChannel scon;
